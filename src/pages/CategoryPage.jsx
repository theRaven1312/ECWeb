...
const CategoryPage = ({heading = "Shop"}) => {
    ...
    const getProductsEndpoint = () => {
        ...
        if (headingLower.includes("shop") || headingLower === "shop") {
            ...
            headingLower.includes("sale") ||
            headingLower.includes("on sales")
        ) {
            return "/api/v1/products?sale=true";
        } else if (
            headingLower.includes("new") ||
            headingLower.includes("arrivals")
        ) {
            return "/api/v1/products?sort=newest";
        } else if (
            headingLower.includes("top") ||
            headingLower.includes("selling") ||
            headingLower.includes("featured")
        ) {
    ...
    const getPageTitle = () => {
        ...
        if (headingLower.includes("new") || headingLower.includes("arrivals"))
            return "New Arrivals";
        if (headingLower.includes("top") || headingLower.includes("selling"))
            return "Top Selling";
        return heading;
    };
            ...
            <div className="flex w-full gap-16">
                ...
                <div className="w-1/5 hidden sm:block">
                    <div className="filter flex flex-col gap-4 p-4 text-gray-500 border-1 border-gray-300 rounded-3xl">
                        ...
                        {/* Clear Filters */}
                        <button
                            className="bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 px-4 rounded-lg cursor-pointer transition-colors duration-200"
